...
## 当前焦点
- 进行中任务：（无）— T-020 已完成，待提交
- 阻塞项：（无）
- 最近更新：2026-06-14（Phase 1 T-020 完成：行政区划查看页与 RegionCascader）
- 下一步：提交 T-020；继续 T-021 任教学科库页 + 选择组件

## 阶段汇总
| Phase | 名称 | 优先级 | 任务数 | 完成 | 状态 |
|---|---|---|---|---|---|
| 0 | 工程脚手架与基础设施 | P0 | 10 | 10 | ✅ 已复核(自建自验) |
| 1 | 基础数据与字典 | P0 | 12 | 10 | 进行中 |
| 2 | 账号角色权限 | P0 | 7 | 0 | 待开始 |
| 3 | 基本信息 | P0 | 9 | 0 | 待开始 |
| 4 | 专业培养信息 | P0 | 5 | 0 | 待开始 |
