...
## 当前焦点
- 进行中任务：（无）— T-011 已完成，待提交
- 阻塞项：（无）
- 最近更新：2026-06-13（Phase 1 T-011 完成：V2 字典/区划/学科/组织表迁移 + 构建/运行验证）
- 下一步：提交 T-011；继续 T-012 字典管理 CRUD + Redis 缓存

## 阶段汇总
| Phase | 名称 | 优先级 | 任务数 | 完成 | 状态 |
|---|---|---|---|---|---|
| 0 | 工程脚手架与基础设施 | P0 | 10 | 10 | ✅ 已复核(自建自验) |
| 1 | 基础数据与字典 | P0 | 12 | 1 | 进行中 |
| 2 | 账号角色权限 | P0 | 7 | 0 | 待开始 |
| 3 | 基本信息 | P0 | 9 | 0 | 待开始 |
| 4 | 专业培养信息 | P0 | 5 | 0 | 待开始 |
...
## Phase 1 · 基础数据与字典 — 1/12
- [x] T-011 字典/区划/学科/组织表（分支：`feature/phase01-T011-dict-schema`）
- [ ] T-012 字典管理 CRUD + Redis 缓存
- [ ] T-013 字典标准值种子
- [ ] T-014 行政区划三级联动
- [ ] T-015 行政区划种子
- [ ] T-016 任教学科标准库服务 + 导入器
- [ ] T-017 任教学科种子（示例库）
- [ ] T-018 学校/学院/专业 + 多培养目标 + 联动配置
- [ ] T-019 字典管理页
- [ ] T-020 行政区划维护 + 级联组件
- [ ] T-021 任教学科库页 + 选择组件
- [ ] T-022 学校/学院/专业维护页
