...
const { colors, controlHeight, radius, typography } = designTokens
...
export const themeOverrides: GlobalThemeOverrides = {
  common: {
    ...
    tableHeaderColor: colors.tableHead,
    tableColorHover: '#f0fdfa',
    tableColorStriped: colors.surfaceSoft,
    hoverColor: '#f0fdfa',
    pressedColor: '#ccfbf1',
    ...
    fontSizeTiny: typography.sizeXs,
    fontSizeSmall: typography.sizeSm,
    fontSizeMedium: typography.sizeBody,
    fontSizeLarge: typography.sizeLg,
    fontSizeHuge: typography.sizeTitle,
  ...
  Button: {
    ...
    heightMedium: controlHeight.medium,
    heightLarge: controlHeight.large,
    borderRadiusTiny: radius.small,
    borderRadiusSmall: radius.control,
    borderRadiusMedium: radius.control,
    borderRadiusLarge: radius.control,
    fontSizeTiny: typography.sizeXs,
    fontSizeSmall: typography.sizeSm,
    fontSizeMedium: typography.sizeBody,
    fontSizeLarge: typography.sizeBody,
    paddingTiny: '0 10px',
    paddingSmall: '0 14px',
