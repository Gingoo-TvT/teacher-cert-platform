...
(8100000000000001, '教学能力展示-陈晓明.mp4', 'demo-teaching-video.mp4', 'phase53-demo-a', 'teaching-video/demo-teaching-video.mp4', 528, 'video/mp4', 'a1b2c3d4e5f60110101112131415161a', 'teaching-video', 800000000000003003, NOW(), NOW(), NOW(), 0),
(8100000000000002, '教学能力展示-周雅婷.mp4', 'demo-teaching-video.mp4', 'phase53-demo-a', 'teaching-video/demo-teaching-video.mp4', 528, 'video/mp4', 'a1b2c3d4e5f60110101112131415162b', 'teaching-video', 800000000000003003, NOW(), NOW(), NOW(), 0),
(8100000000000003, '教学能力展示-郑丽华.mp4', 'demo-teaching-video.mp4', 'phase53-demo-a', 'teaching-video/demo-teaching-video.mp4', 528, 'video/mp4', 'a1b2c3d4e5f60110101112131415163c', 'teaching-video', 800000000000003003, NOW(), NOW(), NOW(), 0),
-- 过程材料 PDF，供 process_material.file_id 引用
(8100000000000011, '教育实习实践证明.pdf', 'demo-material.pdf', 'phase53-demo-a', 'process-material/demo-material.pdf', 659, 'application/pdf', 'b1b2c3d4e5f60110101112131415160d', 'process-material', 800000000000003003, NOW(), NOW(), NOW(), 0),
(8100000000000013, '教师教育课程成绩单.pdf', 'demo-material.pdf', 'phase53-demo-a', 'process-material/demo-material.pdf', 659, 'application/pdf', 'b1b2c3d4e5f60110101112131415161e', 'process-material', 800000000000003003, NOW(), NOW(), NOW(), 0),
(8100000000000014, '专业技能培训证明.pdf', 'demo-material.pdf', 'phase53-demo-a', 'process-material/demo-material.pdf', 659, 'application/pdf', 'b1b2c3d4e5f60110101112131415162f', 'process-material', 800000000000003003, NOW(), NOW(), NOW(), 0),
-- 过程材料 图片（image/png）
(8100000000000012, '师德素养佐证.png', 'demo-material-image.png', 'phase53-demo-a', 'process-material/demo-material-image.png', 99, 'image/png', 'c1b2c3d4e5f60110101112131415160a', 'process-material', 800000000000003003, NOW(), NOW(), NOW(), 0),
-- 免考佐证 PDF，供 exemption_material.file_id 引用
(8100000000000021, '免考佐证-统考成绩单.pdf', 'demo-exemption.pdf', 'phase53-demo-a', 'exemption-material/demo-exemption.pdf', 659, 'application/pdf', 'd1b2c3d4e5f60110101112131415160b', 'exemption-material', 800000000000003003, NOW(), NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE
